...
export const CONFIG = {
  ...
  AI_HESITATE_CHANCE: 0.2, // 매 주기 AI가 아무 행동도 안 할 확률 — 반응을 들쭉날쭉하게(완벽한 타이밍 방지)
  AI_RANDOM_TARGET_CHANCE: 0.55, // 확장 시 가장 약한 대상 대신 이길 만한 인접 대상을 아무거나 고를 확률(비최적 공격)
  AI_ATTACK_MARGIN_JITTER: 0.5, // 판단마다 공격 마진을 ±이 비율로 흔든다 — 과신중/무모를 섞어 타이밍을 흐린다
