...
export const CONFIG = {
  ...
  // 자동 공세 스탠스 — 켜면 최전선 내 동이 매 주기 '이길 만한' 인접 적·중립을 자동 출정(클릭 감소).
  AGGRO_INTERVAL_SEC: 1.2, // 자동 공세 판정 주기(초)
  AGGRO_RATIO: 0.5, // 공세 1회당 최전선 동에서 내보내는 병력 비율
  AGGRO_MIN_TROOPS: 8, // 이 수 미만이면 자동 출정 안 함(수비 병력 확보 + 잔챙이 남발 방지)
  ...
  NUKE_RADIUS_MULT: 3, // 전술핵 반경 = MISSILE_RADIUS_DEG × 3
